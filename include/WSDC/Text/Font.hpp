...
WSDC::Text::TTF_Quitter::~TTF_Quitter() { TTF_Quit(); }
volatile WSDC::Text::TTF_Quitter _WSDC_ttf_quitter = WSDC::Text::TTF_Quitter();

WSDC::Text::CachedText::CachedText() :
    surface(nullptr),
    texture(nullptr),
    renderer(nullptr),
    actual_width(0),
...
void WSDC::Text::CachedText::clear() {
    if (texture) {
...
bool WSDC::Text::CachedText::matches(const std::string& txt, const WSDC::Text::FontStyle& s, SDL_Renderer* ren) const {
    return text == txt && 
           style == s && 
           renderer == ren &&
           surface != nullptr &&
...
void WSDC::Text::Font::prepareContext(SDL_Renderer*& ren, SDL_Surface*& surf, SDL_Texture*& texr, const std::string& txt, int& width, int& height) {
    if (raw == nullptr) {
    ...
    if (raw) {
        ...
        TTF_SetFontStyle(raw, static_cast<TTF_FontStyleFlags>(_style.style));
    ...
    void WSDC::Text::Font::clearCache() {
    cache.clear();
}

void WSDC::Text::Font::applyStyesToFont() {
...
WSDC::Text::Font& WSDC::Text::Font::close(void) {
    clearCache();
...
WSDC::Text::Font& WSDC::Text::Font::unload(void) {
    clearCache();
...
WSDC::Text::Font& WSDC::Text::Font::color(const WSDC::Core::Color& color) {
...
WSDC::Core::Color& WSDC::Text::Font::color(void) {
    return _style.color;
}

WSDC::Text::Font& WSDC::Text::Font::size(const float& size) {
    if (_style.size != size) {
        clearCache();
        _style.size = size;
        if (raw != nullptr) {
...
float& WSDC::Text::Font::size(void) {
    return _style.size;
}

WSDC::Text::Font& WSDC::Text::Font::weight(const WSDC::Text::Weights& weight) {
    if (raw == nullptr) {
...
WSDC::Text::Weights& WSDC::Text::Font::weight(void) {
    return _style.weight;
}

WSDC::Text::Font& WSDC::Text::Font::style(const WSDC::Text::Styles& style) {
    if (raw == nullptr) {
...
WSDC::Text::Styles& WSDC::Text::Font::style(void) {
    return _style.style;
}

WSDC::Text::Font& WSDC::Text::Font::align(const WSDC::Text::Alignment& a) {
    if (raw == nullptr) {
...
WSDC::Text::Font& WSDC::Text::Font::load(const std::string& filepath) {
    _filepath = filepath;
...
std::string& WSDC::Text::Font::filepath(void) {
    return _filepath;
}

WSDC::Text::Font& WSDC::Text::Font::styles(const WSDC::Text::FontStyle& styles) {
...
WSDC::Text::FontStyle& WSDC::Text::Font::styles(void) {
    return _style;
}

SDL_FRect WSDC::Text::Font::write(SDL_Renderer* renderer, const WSDC::Core::Position<float>& pos, 
...
SDL_FRect WSDC::Text::Font::write(SDL_Renderer* r, const WSDC::Core::Position<float>& p, 
                                 const std::string& f, Args... a) {
    return this->write(r, p, WSDC::Format::format(f, a...));
}

SDL_FRect WSDC::Text::Font::measureText(const std::string& text) {
    if (raw == nullptr) {
...
int WSDC::Text::Font::getHeight() const {
    if (raw == nullptr) {
...
int WSDC::Text::Font::getAscent() const {
    if (raw == nullptr) {
...
int WSDC::Text::Font::getDescent() const {
    if (raw == nullptr) {
...
bool WSDC::Text::Font::isLoaded() const {
    return raw != nullptr;
}

WSDC::Text::Font& WSDC::Text::Font::invalidateCache() {
    clearCache();
    return *this;
}
